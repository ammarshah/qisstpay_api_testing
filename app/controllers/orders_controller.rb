class OrdersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order.save
        format.html { redirect_to @order.payment_link, notice: "Order was successfully created." }
  ...
  def callback
    if request.post?
      ...
      order.status = "paid" if order_status == "completed"
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:first_name, :last_name, :email, :phone)
    end
end
